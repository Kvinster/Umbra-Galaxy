		...
		private Texture GetSeverityIcon(IssueSeverity severity)
		{
			...
			switch (severity)
			{
				...
				case IssueSeverity.Error:
					result = CSEditorIcons.ErrorIcon;
					break;
				case IssueSeverity.Warning:
					result = CSEditorIcons.WarnIcon;
					break;
				case IssueSeverity.Info:
					result = CSEditorIcons.InfoIcon;
					break;
				default:
					throw new ArgumentOutOfRangeException();
#else
				case IssueSeverity.Error:
					result = CSEditorIcons.ErrorSmallIcon;
					break;
				case IssueSeverity.Warning:
					result = CSEditorIcons.WarnSmallIcon;
					break;
				case IssueSeverity.Info:
					result = CSEditorIcons.InfoSmallIcon;
					break;
				default:
					throw new ArgumentOutOfRangeException();
#endif
